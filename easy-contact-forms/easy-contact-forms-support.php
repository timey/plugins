...
class EasyContactFormsSupport {
	...
	function getSupportPage() {
		...
		wp_enqueue_script('easy-contact-forms-html', plugins_url('easy-contact-formshtml.1.4.8.js', __FILE__), array(), false, true);

		wp_enqueue_script('easy-contact-forms-env', plugins_url('easy-contact-forms.env.1.4.8.js', __FILE__), array(), false, true);
